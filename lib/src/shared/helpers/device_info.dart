...
class Deviceinformation extends StatefulWidget {
  @override
  _DeviceinformationState createState() => new _DeviceinformationState();
}
...
class _DeviceinformationState extends State<Deviceinformation> {
  ...
  Future<Null> initPlatformState() async {
    ...
    pref.setString('devicedata', deviceData.toString());
    if (!mounted) return;
      ...
      home: new Scaffold(
        ...
        body: new ListView(
          ...
          children: _deviceData.keys.map((String property) {
            // String devicedata = jsonEncode(_deviceData);
            // print('devicedata');
            // print(_deviceData);
            // pref.setString('bspsignup', devicedata);
