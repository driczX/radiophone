class AppConstantsValue {
  static Map<String, dynamic> appConst = {
    'login': {
      'email': {
        'id': 1,
        'translation': 'Email',
    ...
    'floatingbutton': {
      'addinhouse': {
        'id': 1,
        'translation': 'Add In-house Service',
      },
      'addevent': {
        'id': 2,
    ...
    'businessprofile': {
      ...
      'iaccept': {
        'id': 2,
        'translation': 'I accept TUDO terms and conditions',
      },
    },
    'unlicensedsignup': {
      ...
      'documentnumber1': {
        'id': 3,
        'translation': 'Photo Identity document number'
      },
      'issuingauthority1': {
        'id': 4,
      ...
      'documentnumber2': {'id': 5, 'translation': 'Business License No'},
      'issuingauthority2': {
        'id': 6,
        'translation': 'Photo Identification issuing authority'
      },
    ...
    'businessprofile': {
      ...
      'agreeandaccept': {
        'id': 2,
        'translation':
            'I agree and accept to pay charges incurred inverifying my business background',
      },
      'accepttudo': {
        'id': 3,
